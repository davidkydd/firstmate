...
state/               runtime records and signals; gitignored
  ...
  captain-surfaces/  private append-only captain-surface input/output journals, per-client generations and contiguous cursors, and typed-application receipts; bin/fm-captain-surface.sh owns the formats and docs/copilot-app-surface.md owns the GitHub Copilot app client
...
- `copilot-app-surface` - load on a `captain surface input <seq>` check wake, before publishing an outcome or decision to the GitHub Copilot app surface, and when reconciling an uncertain typed-action receipt.
