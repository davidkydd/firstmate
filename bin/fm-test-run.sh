...
tests/fm-backlog-read-bound.test.sh 23941
tests/fm-bearings-board-lavish-live-e2e.test.sh 46
...
tests/fm-calm-claude-mod-plugin.test.sh 233
tests/fm-calm-claude-mod.test.sh 1080
tests/fm-calm-pi-extension.test.sh 256
tests/fm-check-unregister.test.sh 481
tests/fm-ci-workflow.test.sh 2168
...
tests/fm-gemini-harness.test.sh 902
...
tests/fm-harness-precedence.test.sh 3823
tests/fm-herdr-attached-viewer-live-e2e.test.sh 19000
tests/fm-herdr-pi-stale-registration-live-e2e.test.sh 51
...
tests/fm-mail-check.test.sh 11030
tests/fm-mail.test.sh 8176
tests/fm-muse-harness.test.sh 55572
tests/fm-muse-signals-live-e2e.test.sh 23
tests/fm-nm-test-contract.test.sh 122
...
tests/fm-pi-codex-native.test.sh 51
...
tests/fm-pr-reviewers.test.sh 123
tests/fm-pr-state-live-e2e.test.sh 46
tests/fm-pr-state.test.sh 527
...
tests/fm-review-watch-triage.test.sh 227
tests/fm-rovo-harness.test.sh 26664
tests/fm-rovo-signals-live-e2e.test.sh 40
...
tests/fm-send-agy-confirm.test.sh 3502
...
tests/fm-tasks-axi.test.sh 7594
