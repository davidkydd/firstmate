...
The 2026-09-21 refresh from green main runs [35555327738](https://github.com/kunchenguid/firstmate/actions/runs/35555327738), [35541512245](https://github.com/kunchenguid/firstmate/actions/runs/35541512245), and [35540807607](https://github.com/kunchenguid/firstmate/actions/runs/35540807607) added observed maxima of 4963 ms for `fm-ci-workflow.test.sh`, 850 ms for `fm-nm-test-contract.test.sh`, 50 ms for `fm-stat-shadowing.test.sh`, and 1959 ms for `fm-tasks-axi.test.sh`.
