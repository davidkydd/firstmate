...
| `fm-captain-surface.sh`  | Own append-only captain-surface transport, provenance, replay cursors, endpoint generations, and guarded typed-action receipts |
| `fm-copilot-app.sh`      | Check, package, explicitly install, verify, and exactly uninstall the user-scoped GitHub Copilot app surface |
